...
ROUTES = (
    ...
    Route("PATCH", "/agent-gateway/v1/agents-skills/{skill_id}", "skills_default_patch", EnabledPatch, tags=("Skills",)),
    ...
    Route("POST", "/agent-gateway/v1/kanban/boards/{board_slug}/tasks/{task_id}/cancel", "kanban_task_cancel", tags=("Kanban",)),
