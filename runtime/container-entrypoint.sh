...
OMNIROUTE_DATA_DIR="${RUNTIME_PROVIDER_DATA_DIR:-}"
: "${HERMES_HOME:?RUNTIME_AGENT_HOME is required}"
: "${OMNIROUTE_DATA_DIR:?RUNTIME_PROVIDER_DATA_DIR is required}"
export HERMES_HOME OMNIROUTE_DATA_DIR
export HERMES_ROOT_PROFILE="${RUNTIME_AGENT_HOME:-${HERMES_ROOT_PROFILE:-$HERMES_HOME}}"
export HERMES_PROFILES_ROOT="${RUNTIME_AGENT_PROFILES_ROOT:-${HERMES_PROFILES_ROOT:-$HERMES_HOME/profiles}}"
export XDG_CONFIG_HOME="${XDG_CONFIG_HOME:-$HOME/.config}"
export API_SERVER_PORT="${API_SERVER_PORT:-3000}"
