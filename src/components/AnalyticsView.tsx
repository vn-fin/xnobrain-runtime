      ...
      <article className="analytics-panel analytics-attribution-panel">
        ...
        <div className="analytics-retention-note">
          ...
          <div>
            ...
            <span>Deleting a chat or agent no longer changes workspace totals. Historical provider usage has no agent ID, so deleted attribution cannot be reconstructed.</span>
          </div>
        </div>
