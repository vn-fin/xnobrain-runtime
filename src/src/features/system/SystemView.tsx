...
import { systemApi, type BundleDryRun, type DeploymentStatus, type DeviceStatus, type ImportReport } from './api';
    ...
    <div className="system-view">
      ...
      <div className="system-scroll">
        ...
        <section className="system-card system-advanced-card">
          ...
          <div className="system-agent-list">
            {agents.map((agent) => <div className="system-agent-config" key={agent.id}><span>{agent.name}</span><code>profiles/{agent.id}/mcp.json</code></div>)}
          </div>
        </section>
      </div>
    </div>
