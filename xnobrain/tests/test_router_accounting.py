...
FIXTURE = {
    ...
    "application": "xnobrain", "environment": "test", "workspace_id": "workspace_test",
    "agent_ids": ["agent_test"], "period_start": "2026-09-06T00:00:00Z",
    "period_end": "2026-09-13T00:00:00Z", "timezone": "UTC", "week_starts_on": "sunday",
    "as_of": "2026-09-10T00:00:00Z", "accounting_state": "settled",
    "completeness": "durable_records", "freshness": "settled_only",
    "attribution_coverage": "no_usage", "summary": {"requests": 0, "cost_usd": 0},
}
...
class RouterAccountingTests(unittest.TestCase):
    def decision(self, value, limit=20):
        return weekly_budget_decision(
            value, application="xnobrain", environment="test", workspace_id="workspace_test",
            agent_id="agent_test", weekly_usd=limit,
    ...
    def test_wrong_scope_stale_missing_and_incomplete_rejected(self):
        for key, value in [
            ("capability_version", "old"), ("workspace_id", "foreign"),
            ("agent_ids", ["foreign"]), ("completeness", "pending"),
            ("as_of", "2026-09-01T00:00:00Z"), ("summary", {}),
