...
def session_routes(root: str, tags: tuple[str, ...], *, include_in_schema: bool = True) -> tuple:
    return (
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/compact",
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/goal/pause",
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/goal/resume",
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/goal/subgoals",
        ...
        route(
            "DELETE",
            f"{root}/{{conversation_id}}/goal/subgoals/{{subgoal_index}}",
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/chat/stream",
        ...
        route(
            "GET",
            f"{root}/{{conversation_id}}/runs/active",
        ...
        route(
            "GET",
            f"{root}/{{conversation_id}}/runs/{{run_id}}",
        ...
        route(
            "POST",
            f"{root}/{{conversation_id}}/runs/{{run_id}}/stop",
            "run_stop",
            tags=("Runs",),
            include_in_schema=include_in_schema,
        ),
        route(
            "POST",
            f"{root}/{{conversation_id}}/runs/{{run_id}}/approval",
            "run_approval",
            RunApproval,
            tags=("Runs",),
            include_in_schema=include_in_schema,
