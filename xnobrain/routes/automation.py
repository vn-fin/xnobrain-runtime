...
from ..models.automation import CronSchedulePreview, CronSchedulePreviewResult, CronUpdate
...
ROUTES = (
    route(
        ...
        CronSchedulePreview,
        tags=("Cron",),
        response_data=CronSchedulePreviewResult,
    ),
    ...
    route("PATCH", "/cron/jobs/{job_id}", "cron_update", CronUpdate, tags=("Cron",)),
