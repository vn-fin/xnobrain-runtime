...
SESSION_TIMEOUT_ENV = "RUNTIME_SESSION_TIMEOUT_SECONDS"
COMPAT_SESSION_TIMEOUT_ENV = "XNOBRAIN_SESSION_TIMEOUT_SECONDS"
LEGACY_SESSION_TIMEOUT_ENV = "HERMES_SESSION_TIMEOUT_SECONDS"
PARALLEL_AGENTS_ENV = "RUNTIME_DELEGATION_MAX_CONCURRENT_CHILDREN"
COMPAT_PARALLEL_AGENTS_ENV = "XNOBRAIN_MAX_PARALLEL_AGENTS"
LEGACY_PARALLEL_AGENTS_ENV = "DELEGATION_MAX_CONCURRENT_CHILDREN"
DEFAULT_SESSION_TIMEOUT_SECONDS = 86400
...
def session_timeout_seconds(requested: Any = None) -> int:
    ...
    configured = _bounded_int(
        os.getenv(
            SESSION_TIMEOUT_ENV,
            os.getenv(COMPAT_SESSION_TIMEOUT_ENV, os.getenv(LEGACY_SESSION_TIMEOUT_ENV)),
        ),
...
def max_parallel_agents(configured: Any = None) -> int:
    ...
    value = (
        os.getenv(
            PARALLEL_AGENTS_ENV,
            os.getenv(COMPAT_PARALLEL_AGENTS_ENV, os.getenv(LEGACY_PARALLEL_AGENTS_ENV)),
        )
