...
SUBSCRIPTION_PROVIDER_DEFINITIONS = {
    "codex": {
        ...
        "description": "Use an existing ChatGPT or Codex subscription.",
    },
    "claude": {
        "display_name": "Claude Code",
        "description": "Use an existing Claude Code subscription.",
    },
    "github": {
        "display_name": "GitHub Copilot",
        "description": "Use an existing GitHub Copilot subscription.",
    },
    "cursor": {"display_name": "Cursor", "description": "Use an existing Cursor subscription."},
    "grok-cli": {
        "display_name": "Grok Build",
        "description": "Use an existing xAI Grok Build subscription.",
    },
    "xai-oauth": {
        "display_name": "xAI Grok",
        "description": "Use an existing SuperGrok or X Premium+ subscription.",
    },
    "kimi-coding": {
        "display_name": "Kimi Code",
        "description": "Use an existing Kimi Coding Plan subscription.",
    },
    ...
    "kiro": {
        "display_name": "Kiro",
        "description": "Use an existing Kiro or AWS Builder ID account.",
    },
    "amazon-q": {
        "display_name": "Amazon Q Developer",
        "description": "Use an existing Amazon Q Developer or AWS Builder ID account.",
    },
    "clinepass": {
        "display_name": "ClinePass",
        "description": "Use an existing ClinePass subscription.",
    },
    "antigravity": {
        "display_name": "Google Antigravity",
        "description": "Use an existing Google Antigravity account.",
    },
}
PROVIDER_DEFINITIONS = {
    **SUBSCRIPTION_PROVIDER_DEFINITIONS,
    "opencode-go": {
        ...
        "description": "OpenCode Go models from your coding subscription.",
        "base_url": "",
    },
    "opencode": {
        "display_name": "OpenCode Zen",
        "description": "OpenCode Zen models using your Zen API key.",
        "base_url": "",
    },
    **OPENAI_COMPATIBLE_PROVIDER_DEFINITIONS,
}
