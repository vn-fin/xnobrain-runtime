...
- Broader "AI agent" market cited at **$5.25B (2024) → $7.84B (2025) → ~$52.6B by
  ...
  [04-market-and-numbers.md](04-market-and-numbers.md); cite the range, not one point).
...
- (Plus Arize, Confident AI/DeepEval, Maxim, LangSmith.) Gartner: eval-platform adoption
  **18% (2025) → 60% of eng teams (2028)** ([04](04-market-and-numbers.md)).
...
known LLM-judge biases ([06-certification-moat.md](06-certification-moat.md)) mean the
...
Delphi make," you're a category of one. (Cf. [06-certification-moat.md](06-certification-moat.md).)
...
2. **A "good-enough" fake certification** (e.g. an LLM-judge "fidelity %") could
   ...
   objective agreement, not just an LLM score — [06](06-certification-moat.md)).
...
This directly answers the vision's "supply wall" ([02-vision-twin-terminal.md](02-vision-twin-terminal.md) §5):
